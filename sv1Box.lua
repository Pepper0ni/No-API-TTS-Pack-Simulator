...
function getCardTable(trans,num)
 ...
 Memo=date..buildCardNumber(cardData[num].num),
...
function getCustomData(num)
 return{FaceURL=(cardData[num].image or"https://images.pokemontcg.io/"..setID.."/"..cardData[num].num.."_hires.png?count="..cardData[num].num),
