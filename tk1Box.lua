...
function getCustomData(num)
 ...
 if not image then
  if subSetID and num>size then
   image="https://images.pokemontcg.io/"..subSetID.."/"..cardData[num].num.."_hires.png?count="..buildCardNumber(cardData[num].num,1)
  else
   image="https://images.pokemontcg.io/"..setID.."/"..cardData[num].num.."_hires.png?count="..buildCardNumber(cardData[num].num,1)
  end
 end
